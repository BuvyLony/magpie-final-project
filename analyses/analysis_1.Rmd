...
plot1 <-plot(data_plot1, text.size =7)  + theme(axis.text=element_text(color="black",size=30),legend.position="bottom")+ ggtitle("only ingroup")
plot1
ggsave("plot1.png", height = 10, width = 20)

plot2 <-plot(data_plot2, text.size =7)  + theme(axis.text=element_text(color="black",size=30),legend.position="bottom")+ ggtitle("both norms")
plot2
